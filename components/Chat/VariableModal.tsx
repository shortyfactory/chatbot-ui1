...
export const VariableModal: FC<Props> = ({
  prompt,
  variables,
  placeholders = {}, // Default to an empty object
  onSubmit,
  onClose,
}) => {
    ...
    >
      ...
      >
        ...
        <div className="mb-4 text-sm italic text-black dark:text-neutral-200">
          {prompt.description}
          <br />
          In case you don&apos;t want to specify any information, write &quot;none&quot;.
        </div>

        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            <div className="mb-2 text-sm font-bold text-neutral-500">
              {placeholders[variable.key] || variable.key}
            </div>
