...
export const ChatMessage: FC<Props> = memo(({ message, messageIndex, onEdit }) => {
  ...
  useEffect(() => {
    ...
    return (
        <div className={`group md:px-4 ${message.role === 'assistant' ? 'border-b border-black/10 bg-gray-50 text-gray-800 dark:border-gray-900/50 dark:bg-[#444654] dark:text-gray-100' : 'border-b border-black/10 bg-white text-gray-800 dark:border-gray-900/50 dark:bg-[#343541] dark:text-gray-100'}`} style={{ overflowWrap: 'anywhere' }}>
                                        ...
                                        <div className="variables-list" style={{ marginTop: '20px' }}>
                                            {message.variables2.map((variable, index) => (
                                                <div key={index} style={{ fontSize: '0.8em', color: '#555' }}>
                                                    <span style={{ fontWeight: 'bold' }}>{variable.name}</span>: {variable.value}
                                                </div>
                                            ))}
                                        </div>
                                    )}
